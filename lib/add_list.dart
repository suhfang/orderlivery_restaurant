      ...
      body: SafeArea(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                  'Lists with prices are a great to add Extras, Add-Ons, and more that the user can add for an additional price. For example, if you want to charge the user \$0.50 for an extra sauce on top of the one that comes with the item.'),
              SizedBox(
                height: 20,
              ),
              CheckboxListTile(
...
//                    focusNode: nameFocusNode,
                  inputFormatters: [],
                  hintText:
                      'Ex: Choose your Flavor, Pick a Topping, Choose Drink, etc.',
                  onChanged: (String value) {
                    _title = value.trim();
...
//                  controller: descriptionController,
                ...
                decoration: InputDecoration(
                    hintText:
                        'Ex: Please choose at least one flavor in order to proceed',
                    hintMaxLines: 200,
              ...
              Text(
                  'You can create a list of items. Ex: Flavors of Wings, Sauce, Dressing, etc.'),
              SizedBox(
                height: 10,
              ),
              Expanded(
                    ...
                    new Expanded(
                      child: new TextField(
                        ...
                        decoration: new InputDecoration(
                            ...
                            hintText: 'Ex: Mild, Medium, Hot, Mega Hot'),
                      ),
                    ),
                  ],
                ),
            ...
            new FlatButton(
                ...
                onPressed: () {
                  if (_currentItem.name.trim().isNotEmpty &&
                      _currentItem.price.trim().isNotEmpty) {
              ...
              children: <Widget>[
                new Expanded(
                  child: new TextField(
                    ...
                    decoration: new InputDecoration(
                        labelText: 'List item name',
                        hintText: 'eg. Mild, Medium, Hot, Mega Hot'),
                  ),
                )
              ],
            ),
            actions: <Widget>[
              ...
              new FlatButton(
                  ...
                  onPressed: () {
                    if (_currentItem.name.trim().isNotEmpty) {
                      List<String> names =
                          list_items.map((e) => e.name).toList();
                      if (!names.contains(_currentItem.name.trim())) {
                        setState(() {
                          list_items.add(_currentItem);
                        });
